...
class JWT
{
     ...
     */
    public static function decode($jwt, $key = 'secret_key', array $allowed_algs = ['HS256'])
    {
     ...
     */
    public static function encode($payload, $key = 'secret_key', $alg = 'HS256', $keyId = null, $head = null)
    {
    ...
    public static function getBearerToken()
    {
        ...
        throw new \Exception('ERROR in JWT Token');
    }
